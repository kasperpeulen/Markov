\exercise{1.1.3a}{Let $X$ be a random variable with values in a countable set $I$. Let $Y_1,Y_2,...$ be a sequence of independent random variables, uniformly distributed on $[0,1]$. Suppose we are given a function $G: I \times [0,1] \to I$ and define inductively $X_{n+1}=G(X_n,Y_{n+1})$. Show that $(X_n)_{n\geq 0}$ is a Markov chain and express its transition matrix $P$ in terms of $G$.}
